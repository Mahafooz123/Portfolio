        ...
        {experienceData.map((job, index) => (
          ...
          >
            <div className="flex justify-between items-start mb-2">
              <h4 className="text-3xl font-sans font-bold text-light-text">{job.title}</h4>
              <span className="text-accent-gold font-mono text-sm uppercase tracking-widest">{job.duration}</span>
            </div>
            <p className="text-xl font-mono text-light-text/80 mb-4">{job.company}</p>
